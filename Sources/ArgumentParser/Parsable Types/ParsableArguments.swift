...
extension ParsableArguments {
  ...
  /// `CleanExit` error, this method prints help information and exits with code
  /// `EXIT_SUCCESS`. Otherwise, this method prints a relevant error message and
  /// exits with code `EX_USAGE` or `EXIT_FAILURE`.
  ///
